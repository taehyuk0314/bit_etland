...
<meta charset="UTF-8">
  ...
  <!-- Favicons -->
  <link href="${img}/home/favicon.png" rel="icon">
  <link href="${img}/home/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,700|Raleway:300,400,400i,500,500i,700,800,900" rel="stylesheet">

  <!-- Bootstrap CSS File -->
  <link href="${lib}/home/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Libraries CSS Files -->
  <link href="${lib}/home/nivo-slider/css/nivo-slider.css" rel="stylesheet">
  <link href="${lib}/home/owlcarousel/owl.carousel.css" rel="stylesheet">
  <link href="${lib}/home/owlcarousel/owl.transitions.css" rel="stylesheet">
  <link href="${lib}/home/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="${lib}/home/animate/animate.min.css" rel="stylesheet">
  <link href="${lib}/home/venobox/venobox.css" rel="stylesheet">
  ...
  <div class="item" id="content">
    ...
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="${img}/home/slider/slider1.jpg" alt="" title="#slider-direction-1" />
        <img src="${img}/home/slider/slider2.jpg" alt="" title="#slider-direction-2" />
        <img src="${img}/home/slider/slider3.jpg" alt="" title="#slider-direction-3" />
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              <a href="#">
                <h4 class="sec-head"><a href="#" id="signin_btn">SIGN IN</a></h4>
              </a>
              <p>
              로그인창 화면입니다
              </p>
      ...
      <div class="row">
        ...
        <div class="awesome-project-content">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/1.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/1.jpg">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/2.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/2.jpg">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/3.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/3.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/4.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/4.jpg">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/5.jpg" alt="" /></a>
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/5.jpg">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="${img}/home/portfolio/6.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="${img}/home/portfolio/6.jpg">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              <div class="single-blog-img">
                <a href="blog.html">
										<img src="${img}/home/blog/1.jpg" alt="">
									</a>
              </div>
              <div class="blog-meta">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              <div class="single-blog-img">
                <a href="blog.html">
										<img src="${img}/home/blog/3.jpg" alt="">
									</a>
              </div>
              <div class="blog-meta">
                <span class="comments-type">
